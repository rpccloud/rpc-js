...
export class RPCStream {
  ...
  public putBytes(value: number[]): void {
  ...
  public setClientCallbackID(id: number) {
    const originWritePos = this.writePos;
  ...
  public writeFloat64(value: RPCFloat64) {
  ...
  public writeInt64(value: RPCInt64) {
